...
>
> You can define the role as _ML Research Scientist/Engineer_. However, the work interfaced heavily with Platform Engineering, which echoed back with my experience at [Bloomberg](#bloomberg-lp) as a senior software engineer in Platform. In addition, due to the visual nature of computer vision, being able to anticipate and connect to the frontend/product experience was essential. Therefore I took an IC liaison role at adjacent teams and contributed heavy-handedly to a few projects. The aim was to drive the initiatives to the logical conclusions and reap the benefits of what the ML core had to offer. Through them I got to really stretch my abilities. The hands-on technical experience and intuition I gained from these projects were priceless.
>
